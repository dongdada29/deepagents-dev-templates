  ...
  "agent_servers": {
    "deepagents-template": {
      ...
      "args": [
        "--import",
        "tsx",
        "/absolute/path/to/deepagents-dev-templates/packages/deepagents-app-ts/src/index.ts",
        "--config",
        "/absolute/path/to/deepagents-dev-templates/packages/deepagents-app-ts/config/app-agent.config.json"
      ],
      "env": {
        "LLM_PROVIDER": "openai",
...
LOG_LEVEL=debug \
LOG_DIR=/absolute/path/to/deepagents-dev-templates/logs \
node --import tsx /absolute/path/to/deepagents-dev-templates/packages/deepagents-app-ts/src/index.ts \
  --config /absolute/path/to/deepagents-dev-templates/packages/deepagents-app-ts/config/app-agent.config.json
```
